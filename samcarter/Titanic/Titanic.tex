...
\begin{frame}
  \begin{tikzpicture}[
    ...
    \begin{scope}
      ...
      \node[anchor=south] at (0.8,0.25-0.3*\slideinframe/\steps) {\includegraphics[width=1.5cm]{ship}};
    \end{scope}
    
    \node[rotate=3*sin(\slideinframe/2)] at (0.4,0.3) {\includegraphics[width=7cm]{door}};
